...
const Timeline = () => {
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-background via-peach-light/20 to-gold-light/30">
      <FloatingHearts />
          ...
          <div className="space-y-8">
            {timelineData.map((item, index) => {
              ...
              return (
                <Card
                  key={item.year}
                  className="relative p-6 md:p-8 backdrop-blur-sm bg-card/80 border-2 hover:shadow-xl transition-all duration-300 hover:scale-[1.02] animate-fadeIn"
